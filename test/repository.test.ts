...
import { SQLiteRegistrationRepository, SQLiteEmailRepository, Registration, SentEmail } from '../src/api/persistence';
import fs from 'fs';
...
describe('SQLite Persistence', () => {
  ...
  it('should find all registrations', () => {
    regRepo.create({ email: '1@test.com', status: 'Pending', registeredAt: '1', origen: 'O' });
    regRepo.create({ email: '2@test.com', status: 'Approved', registeredAt: '2', origen: 'O' });
  ...
  it('should persist across restarts', () => {
    regRepo.create({ email: 'persist@test.com', status: 'Pending', registeredAt: '1', origen: 'O' });
